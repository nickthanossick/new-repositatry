...
| `ri_e_fx.js` | ward curtains, fans, pipes, dust in the torch beam, lightning in the windows, per-frame update |
...
random stream. Naina, the story items, missions and audio are not touched.
